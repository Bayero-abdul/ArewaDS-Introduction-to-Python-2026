...
| 2 | Data Types & Expressions | [Slides](slide/w2.pdf) | [Lab](notebooks/w2.ipynb) | [Session 1](https://youtu.be/2pj4_SbwybY), [Session 2](https://youtu.be/rdnLVYVQE_g)  | `int` / `float` / `str`, arithmetic, precedence, type conversion, f-strings | Ch. 2 | [Dr. I.S. Ahmad](https://isahmadbbr.github.io)|
...
| 4 | Repetition with Loops | TBA | TBA | [Session 1](https://youtu.be/ZVJlCmT9UTc), [Session 2](https://youtu.be/-FzbIk-Caxo) | `while`, `for`, `range`, accumulator & sentinel patterns | Ch. 3 (loops) | TBA |
